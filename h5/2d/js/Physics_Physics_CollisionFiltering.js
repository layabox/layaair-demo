...
(function (exports, Laya) {
    ...
    Physics_Physics_CollisionFiltering.k_smallGroup = 1;
    Physics_Physics_CollisionFiltering.k_middleGroup = 0;
    Physics_Physics_CollisionFiltering.k_largeGroup = -1;
    Physics_Physics_CollisionFiltering.k_triangleCategory = 0x2;
    Physics_Physics_CollisionFiltering.k_boxCategory = 0x4;
    Physics_Physics_CollisionFiltering.k_circleCategory = 0x8;
    Physics_Physics_CollisionFiltering.k_triangleMask = 0xF;
    Physics_Physics_CollisionFiltering.k_boxMask = 0xF ^ Physics_Physics_CollisionFiltering.k_circleCategory;
    Physics_Physics_CollisionFiltering.k_circleMask = Physics_Physics_CollisionFiltering.k_triangleCategory | Physics_Physics_CollisionFiltering.k_boxCategory | 0x01;
    new Physics_Physics_CollisionFiltering();

    exports.Physics_Physics_CollisionFiltering = Physics_Physics_CollisionFiltering;
