package physicsModule {
	...
	public class PhysicsWorld_CollisionFiflter {
		...
		public function PhysicsWorld_CollisionFiflter() {
			...
			plane = scene.addChild(new MeshSprite3D(new PlaneMesh(20, 20, 10, 10))) as MeshSprite3D;
		...
		public function addKinematicSphere():void {
			...
			rigidBody.canCollideWith = Physics3DUtils.COLLISIONFILTERGROUP_CUSTOMFILTER1;//只与自定义组1碰撞(如果多组采用位操作）
