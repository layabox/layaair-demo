var StandardMaterial_SpecularMap = /** @class */ (function () {
    function StandardMaterial_SpecularMap() {
        ...
        this.specularMapUrl = [
            "../../res/threeDimen/threeDimen/skinModel/dude/Assets/dude/headS.png",
            "../../res/threeDimen/threeDimen/skinModel/dude/Assets/dude/jacketS.png",
            "../../res/threeDimen/threeDimen/skinModel/dude/Assets/dude/pantsS.png",
            "../../res/threeDimen/threeDimen/skinModel/dude/Assets/dude/upBodyS.png",
            "../../res/threeDimen/threeDimen/skinModel/dude/Assets/dude/upBodyS.png"
        ];
        Laya3D.init(0, 0);
        ...
        Laya.loader.create("../../res/threeDimen/threeDimen/skinModel/dude/dude.lh", completeHandler);
    }
    StandardMaterial_SpecularMap.prototype.onComplete = function () {
        var dude1 = this.scene.addChild(Laya.Sprite3D.load("../../res/threeDimen/threeDimen/skinModel/dude/dude.lh"));
        ...
        for (var i = 0; i < skinnedMeshSprite3d.skinnedMeshRenderer.materials.length; i++) {
            var mat = skinnedMeshSprite3d.skinnedMeshRenderer.materials[i];
            //高光贴图
