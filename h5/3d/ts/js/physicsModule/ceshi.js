var ceshi = /** @class */ (function () {
    function ceshi() {
        ...
        planeMat.albedoTexture = Laya.Texture2D.load("../../res/threeDimen/texture/layabox.png");
        //拉伸UV
    ...
    ceshi.prototype.randomAddPhysicsSprite = function () {
        Laya.timer.loop(1000, this, this.loopfun);
    };
    ceshi.prototype.loopfun = function () {
    ...
    ceshi.prototype.addBox = function () {
        //设置BlinnPhong材质
        var mat1 = new Laya.BlinnPhongMaterial();
        //添加漫反射贴图
        //mat1.albedoTexture = Laya.Texture2D.load("PhysicsWorld/rocks.jpg");
    ...
    ceshi.prototype.addSphere = function () {
        var mat2 = new Laya.BlinnPhongMaterial();
        //
        //mat2.albedoTexture = Laya.Texture2D.load("PhysicsWorld/plywood.jpg");
    ...
    ceshi.prototype.addCapsule = function () {
        var mat3 = new Laya.BlinnPhongMaterial();
        //mat3.albedoTexture = Laya.Texture2D.load("PhysicsWorld/wood.jpg");
