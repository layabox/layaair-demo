var PhysicsWorld_RayShapeCast = /** @class */ (function () {
    function PhysicsWorld_RayShapeCast() {
        this.castType = 0;
        this.castAll = false;
        ...
        this.addButton(200, 400, 160, 40, "检测", function (e) {
            ...
            switch (this.castType) {
                case 0:
                    ...
                    lineSprite.setLine(0, from, to, Laya.Color.RED, Laya.Color.RED);
    ...
    PhysicsWorld_RayShapeCast.prototype.addButton = function (x, y, width, height, text, clikFun) {
    ...
    PhysicsWorld_RayShapeCast.prototype.addBox = function () {
    ...
    PhysicsWorld_RayShapeCast.prototype.addCapsule = function () {
    ...
    return PhysicsWorld_RayShapeCast;
}());
