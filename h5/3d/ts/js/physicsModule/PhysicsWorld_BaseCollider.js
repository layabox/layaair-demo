var PhysicsWorld_BaseCollider = /** @class */ (function () {
    function PhysicsWorld_BaseCollider() {
        //初始化引擎
        Laya3D.init(0, 0);
        //设置画布模式
    ...
    PhysicsWorld_BaseCollider.prototype.randomAddPhysicsSprite = function () {
        Laya.timer.loop(1000, this, this.loopfun);
    };
    PhysicsWorld_BaseCollider.prototype.loopfun = function () {
    ...
    PhysicsWorld_BaseCollider.prototype.addBox = function () {
        //设置BlinnPhong材质
    ...
    PhysicsWorld_BaseCollider.prototype.addSphere = function () {
    ...
    PhysicsWorld_BaseCollider.prototype.addCapsule = function () {
    ...
    return PhysicsWorld_BaseCollider;
}());
