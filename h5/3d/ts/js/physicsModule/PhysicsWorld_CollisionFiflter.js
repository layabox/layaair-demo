var PhysicsWorld_CollisionFiflter = /** @class */ (function () {
    function PhysicsWorld_CollisionFiflter() {
        Laya3D.init(0, 0);
    ...
    PhysicsWorld_CollisionFiflter.prototype.addKinematicSphere = function () {
    ...
    PhysicsWorld_CollisionFiflter.prototype.onKeyDown = function () {
        ...
        Laya.KeyBoardManager.hasKeyDown(81) && this.plane.transform.translate(new Laya.Vector3(-0.01, 0, 0));
        ; //Q
        Laya.KeyBoardManager.hasKeyDown(69) && this.plane.transform.translate(new Laya.Vector3(0.01, 0, 0));
        ; //E
    };
    PhysicsWorld_CollisionFiflter.prototype.addBox = function () {
    ...
    PhysicsWorld_CollisionFiflter.prototype.addCapsule = function () {
    ...
    return PhysicsWorld_CollisionFiflter;
}());
