var PhysicsWorld_MeshCollider = /** @class */ (function () {
    function PhysicsWorld_MeshCollider() {
        Laya3D.init(0, 0);
    ...
    PhysicsWorld_MeshCollider.prototype.complete = function () {
    ...
    PhysicsWorld_MeshCollider.prototype.randomAddPhysicsSprite = function () {
    ...
    PhysicsWorld_MeshCollider.prototype.addBox = function () {
    ...
    PhysicsWorld_MeshCollider.prototype.addSphere = function () {
    ...
    PhysicsWorld_MeshCollider.prototype.addCapsule = function () {
    ...
    return PhysicsWorld_MeshCollider;
}());
