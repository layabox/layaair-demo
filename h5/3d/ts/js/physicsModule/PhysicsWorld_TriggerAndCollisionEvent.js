var PhysicsWorld_TriggerAndCollisionEvent = /** @class */ (function () {
    function PhysicsWorld_TriggerAndCollisionEvent() {
        Laya3D.init(0, 0);
    ...
    PhysicsWorld_TriggerAndCollisionEvent.prototype.addKinematicSphere = function () {
    ...
    PhysicsWorld_TriggerAndCollisionEvent.prototype.onKeyDown = function () {
    ...
    PhysicsWorld_TriggerAndCollisionEvent.prototype.addBoxAndTrigger = function () {
    ...
    PhysicsWorld_TriggerAndCollisionEvent.prototype.addCapsuleCollision = function () {
    ...
    PhysicsWorld_TriggerAndCollisionEvent.prototype.addSphere = function () {
        var mat2 = new Laya.BlinnPhongMaterial();
        Laya.Texture2D.load("../../res/threeDimen/Physics/plywood.jpg", Laya.Handler.create(null, function (tex) {
            mat2.albedoTexture = tex;
        }));
    ...
    return PhysicsWorld_TriggerAndCollisionEvent;
}());
new PhysicsWorld_TriggerAndCollisionEvent;
