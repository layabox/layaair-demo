var PhysicsWorld_ContinueCollisionDetection = /** @class */ (function () {
    function PhysicsWorld_ContinueCollisionDetection() {
        Laya3D.init(0, 0);
    ...
    PhysicsWorld_ContinueCollisionDetection.prototype.addSphere = function () {
    ...
    return PhysicsWorld_ContinueCollisionDetection;
}());
