class PhysicsWorld_TriggerAndCollisionEvent
{
    ...
    public addBoxAndTrigger():void {
        ...
        var script:Laya.TriggerCollisionScript = box.addComponent(TriggerCollisionScript);
    ...
    public addCapsuleCollision():void {
        ...
        rigidBody.colliderShape = sphereShape;
        rigidBody.mass = 10;
        var script:Laya.TriggerCollisionScript = capsule.addComponent(TriggerCollisionScript);
        script.kinematicSprite = this.kinematicSphere;
