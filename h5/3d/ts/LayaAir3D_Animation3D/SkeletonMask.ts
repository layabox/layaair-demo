...
export class SkeletonMask {
	...
	constructor() {
		...
		//加载场景
		Scene3D.load("res/threeDimen/scene/LayaScene_MaskModelTest/Conventional/MaskModelTest.ls", Handler.create(this, function (scene: Scene3D): void {
	...
	private loadFont(): void {
		...
		bitmapFont.loadFont("res/threeDimen/scene/LayaScene_MaskModelTest/font/fontClip.fnt", new Handler(this, this.onFontLoaded, [bitmapFont]));
	}
	...
	private createText(font: string): void {
		...
		txt.pos(Laya.stage.width / 2 - 240 , 450);
	...
	createText1(font) {
		...
		txt.leading = 5;
		txt.zOrder = 999999999;
		txt.pos(Laya.stage.width / 2, 450);
		Laya.stage.addChild(txt);
	} 
	createText2(font) {
		var txt = new Text();
		...
		txt.leading = 5;
		txt.zOrder = 999999999;
		txt.pos(Laya.stage.width / 2 + 140, 450);
		Laya.stage.addChild(txt);
	}
