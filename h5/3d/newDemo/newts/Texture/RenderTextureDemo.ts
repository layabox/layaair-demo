...
class RenderTextureDemo
{
	...
	private onComplete():void {
		...
		var renderTargetObj = scene.getChildAt(0).getChildByName("RenderTarget") as Laya.MeshSprite3D;
		
		Laya.loader.load(["res/threeDimen/ui/button.png"], Laya.Handler.create(this, function():void {
			var changeActionButton = Laya.stage.addChild(new Laya.Button("res/threeDimen/ui/button.png", "渲染目标")) as Laya.Button;
			...
			changeActionButton.on(Laya.Event.CLICK, this, function():void {
				...
				var boxMaterial:Laya.BlinnPhongMaterial = this.box.meshRenderer.material as Laya.BlinnPhongMaterial;
				//获取BlinnPhong材质的纹理
				var tex:Laya.Texture2D = boxMaterial.albedoTexture as Laya.Texture2D;
