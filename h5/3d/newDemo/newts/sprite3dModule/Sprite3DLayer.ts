...
class Sprite3DLayer{
    ...
    constructor(){
		...
		this._scene.addChild(this.camera);
    ...
    onComplete(){
        //添加地面
        var grid:Laya.Sprite3D = this._scene.addChild(Laya.Loader.getRes("res/threeDimen/staticModel/grid/plane.lh")) as Laya.Sprite3D;
        //地面接收阴影
