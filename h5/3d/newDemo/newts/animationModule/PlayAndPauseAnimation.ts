...
class PlayAndPauseAnimation{
    ...
    onLoadFinish(){
		...
		//初始化角色精灵
		var role:Laya.Sprite3D = new Laya.Sprite3D();
		this.scene.addChild(role);
			
		//初始化胖子
		var pangzi:Laya.Sprite3D = role.addChild(Laya.Loader.getRes("res/threeDimen/skinModel/BoneLinkScene/PangZi.lh")) as Laya.Sprite3D;
		//获取动画组件
