...
class CameraDemo 
	{
		...
		private onPreLoadFinish()
        {
			...
			//为材质加载纹理
			var tex = Laya.Loader.getRes("res/threeDimen/texture/layabox.png") as Laya.Texture2D;
			//设置反照率贴图
		...
		private loadUI() {
			...
			Laya.loader.load(["res/threeDimen/ui/button.png"], Laya.Handler.create(this, function():void {
				...
				var changeActionButton = new Laya.Button("res/threeDimen/ui/button.png", "正透切换");
				...
				var changeActionButton2 = new Laya.Button("res/threeDimen/ui/button.png", "切换背景");
