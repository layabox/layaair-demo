package OfficialExample.LayaAir3D_MouseInteraction 
{
	...
	public class MouseInteraction 
	{
		...
		private function onComplete():void {
			...
			//克隆sprite3d
			var layaMonkey_clone1:MeshSprite3D = Sprite3D.instantiate(staticLayaMonkey, _scene, false, new Vector3(0.0, 0, 0.5)) as MeshSprite3D;
			var layaMonkey_clone2:MeshSprite3D = Sprite3D.instantiate(staticLayaMonkey, _scene, false, new Vector3(0.0, 0, 0.5)) as MeshSprite3D;
			var layaMonkey_clone3:MeshSprite3D = Sprite3D.instantiate(staticLayaMonkey, _scene, false, new Vector3(0.0, 0, 0.5)) as MeshSprite3D;
			//设置精灵名字
