...
(function (Laya) {
	...
	class LoadGltfRosource {
	    constructor() {
	        ...
	        Laya.Laya.loader.create(gltfResource, Laya.Handler.create(this, this.onGLTFComplate));
	    }
	    onGLTFComplate(success) {
	        ...
	        var RiggedFigure = Laya.Loader.getRes("res/threeDimen/gltf/RiggedFigure/RiggedFigure.gltf");
	        ...
	        var duck = Laya.Loader.getRes("res/threeDimen/gltf/Duck/Duck.gltf");
	        this.scene.addChild(duck);
	        var cube = Laya.Loader.getRes("res/threeDimen/gltf/AnimatedCube/AnimatedCube.gltf");
