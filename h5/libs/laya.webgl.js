...
var TextTexture=(function(_super){
	...
	*/
	__proto.addChar=function(data,x,y,uv){
		...
		var u0=(x+1)/ this._texW;
		var v0=(y+1)/ this._texH;
		var u1=(x+data.width-1)/ this._texW;
		var v1=(y+data.height-1)/ this._texH;
		uv=uv || new Array(8);
		uv[0]=u0,uv[1]=v0;
		uv[2]=u1,uv[3]=v0;
		uv[4]=u1,uv[5]=v1;
	...
	*/
	__proto.addCharCanvas=function(canv,x,y,uv){
		...
		var u0=(x+1)/ this._texW;
		var v0=(y+1)/ this._texH;
		var u1=(x+canv.width-1)/ this._texW;
		var v1=(y+canv.height-1)/ this._texH;
		uv=uv || new Array(8);
		uv[0]=u0,uv[1]=v0;
		uv[2]=u1,uv[3]=v0;
		uv[4]=u1,uv[5]=v1;
