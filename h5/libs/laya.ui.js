...
(function(window,document,Laya){
	...
	var Rectangle=laya.maths.Rectangle,Scene=laya.display.Scene,SceneUtils=laya.utils.SceneUtils,Sprite=laya.display.Sprite;
	var Stage=laya.display.Stage,Text=laya.display.Text,Texture=laya.resource.Texture,TimeLine=laya.utils.TimeLine;
...
var View=(function(_super){
	...
	*/
	...
	View.__init$=function(){
		ClassUtils.regShortClassName([ViewStack,Button,TextArea,ColorPicker,Box,ScaleBox,CheckBox,Clip,ComboBox,UIComponent,HScrollBar,HSlider,Image,Label,List,Panel,ProgressBar,Radio,RadioGroup,ScrollBar,Slider,Tab,TextInput,View,Dialog,VScrollBar,VSlider,Tree,HBox,VBox,Sprite,Animation,Text,FontClip]);
	}
