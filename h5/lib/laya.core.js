...
var WebAudioSoundChannel=(function(_super){
	...
	*/
	__proto.play=function(){
		...
		if (this.gain.gain.setTargetAtTime){
			this.gain.gain.setTargetAtTime(this._volume,this.context.currentTime,0);
		}else
		...
		if (bufferSource.playbackRate.setTargetAtTime){
			bufferSource.playbackRate.setTargetAtTime(SoundManager.playbackRate,this.context.currentTime,0)
		}else
	...
	*/
	__getset(0,__proto,'volume',function(){
		...
		this._volume=v;
		if (this.gain.gain.setTargetAtTime){
			this.gain.gain.setTargetAtTime(v,this.context.currentTime,0);
		}else
